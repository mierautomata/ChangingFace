...
public class ChangingFace extends Application {
    ...
    public void start(Stage stage) {
        ...
        caption = new Text(68, 240, "Changing Face");
        ...
        // create a button that will change the color of the face
        ...
        buttonBox.getChildren().addAll(smileButton, frownButton, colorButton, wowButton);
        ...
        smileButton.setOnAction(e -> {
            mouth.setLength(-180);
            caption.setText("Smiling");
        });

        // supply the code that is executed when the frown button is pressed
        frownButton.setOnAction(e -> {
            mouth.setLength(180);
            caption.setText("Frowning");
        });
        
        wowButton.setOnAction(e -> {
            mouth.setLength(360);
            caption.setText("Wow");
        });

        // supply the code that is executed when the color button is pressed
        colorButton.setOnAction(e -> {
            Random rand = new Random();
            double red = rand.nextDouble();
            double green = rand.nextDouble();
            double blue = rand.nextDouble();
            face.setFill(Color.color(red, green, blue)); // Change color to random
            caption.setText("Color Changed");
        });

        // add the scene to the stage, then set the title
        stage.setScene(scene);
        stage.setTitle("Changing Face by Herrick Van Elmer B. Boquel");
